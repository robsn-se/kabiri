...
// Array.from() перебирает каждый элемент и добавляет его в новый массив.

// Files это свойство которое позволяет получить доступ к списку файлов

// FileReader это объект в js имеет одно назначение: чтение данных из файла и сохранение их в переменной JavaScript.

// onload - это "onloadend". Он запускается после полной загрузки изображения. Для изображения нет другого события загрузки.
